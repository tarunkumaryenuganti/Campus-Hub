            ...
            <div className="max-w-7xl mx-auto">
                <div className="bg-amber-500/5 backdrop-blur-xl border border-amber-500/20 rounded-2xl p-8 shadow-2xl">
                    <div className="flex justify-between items-center mb-8">
                        <div>
                            <h1 className="text-4xl font-bold text-amber-700 font-semibold mb-2">
                                Event Management
                            </h1>
                        ...
                        <button
                            ...
                            className="px-6 py-3 bg-gradient-to-r from-amber-500 to-orange-600 hover:from-amber-600 hover:to-orange-700 text-slate-900 font-medium font-semibold rounded-lg shadow-lg hover:shadow-orange-500/30 transition-all duration-200"
                        >
                    ...
                    {showForm && (
                        <div className="mb-12 max-w-2xl">
                            <h2 className="text-xl font-bold text-slate-900 font-medium mb-4">Create New Event</h2>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
                        <div className="bg-white/95 backdrop-blur-xl rounded-xl p-6 border border-amber-500/10">
                            <h3 className="text-sm font-medium text-amber-200 mb-2">Active Events</h3>
                            <p className="text-3xl font-bold text-slate-900 font-medium">{events.length}</p>
                        </div>
                        <div className="bg-white/95 backdrop-blur-xl rounded-xl p-6 border border-amber-500/10">
                            <h3 className="text-sm font-medium text-amber-200 mb-2">Total RSVPs</h3>
                            <p className="text-3xl font-bold text-slate-900 font-medium">1,240</p>
                        </div>
                        <div className="bg-white/95 backdrop-blur-xl rounded-xl p-6 border border-amber-500/10">
                            <h3 className="text-sm font-medium text-amber-200 mb-2">Revenue (Fees)</h3>
                            <p className="text-3xl font-bold text-slate-900 font-medium">₹{events.reduce((acc, e) => acc + (e.fees || 0), 0) * 10}</p>
                        </div>
                    </div>

                    <div className="bg-white/95 backdrop-blur-xl rounded-xl overflow-hidden border border-slate-400">
                        <table className="w-full text-left">
                            <thead className="bg-white/95 backdrop-blur-xl text-amber-200 text-sm">
                                <tr>
                            ...
                            <tbody className="divide-y divide-white/5 text-slate-900 font-medium/80">
                                {events.map(evt => (
                                    <tr key={evt.id} className="hover:bg-white/95 backdrop-blur-xl transition-colors">
